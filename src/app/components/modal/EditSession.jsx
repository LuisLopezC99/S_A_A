...
function EditSession({ isModalOpen, handleModalState, sessionData }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const rep = putData("session", { id, date, report: name != "" ? name : report, type, UrlVideo: facebookUrl })
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="bg-white p-4 rounded shadow-lg z-10 dark:bg-gray-700">
            <h2 className="text-2xl font-bold mb-4 dark:text-white" >Editar Sesion</h2>
            <form onSubmit={handleSubmit}>
              <div className="flex mb-4">
                ...
                <div>
                  <label className="block text-gray-700 text-sm font-bold mb-2 dark:text-white" htmlFor="type">
                    Tipo:
                  </label>
                  <select
                    id="type"
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2 dark:text-white" htmlFor="facebookUrl">
                  Link de Facebook:
                </label>
                <input
                  className="custom-input"
              ...
              <div className="mb-4">
                ...
                />
                <div>
                  Archivo original: {sessionData.report}
                </div>
              </div>
