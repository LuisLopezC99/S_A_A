...
import { postData } from '@/app/requests/getRequests';
...
function FormSession({ isModalOpen, handleModalState }) {
  ...
  const handleSubmit = async ( event) => {
    ...
    const rep = postData( "session", {date, report:name, type, UrlVideo: facebookUrl})
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="bg-white p-4 rounded shadow-lg z-10 dark:bg-gray-700">
            <h2 className="text-2xl font-bold mb-4 dark:text-white" >Crear Session</h2>
