...
export default  ProfileModal = ({ isModalOpen, handleModalState, userData })  => {
    ...
    return (    
        <div>
            {isModalOpen && <div ref={ref} className="dark:bg-gray-700 w-96 absolute z-50 mt-1 w-48 md:w-64 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 origin-top-right right-0">
                <div className="flex flex-col items-center">
                    ...
                    <div className="ml-4 text-center">
                        <p className="text-lg font-medium dark:text-white">{ userData["name"].split(' ')[0] }</p>
                    ...
                    <div className="mt-4 border-t border-b border-gray-350">
                        <ul className="flex flex-col items-left text-sm">
                            <li className="mt-1 mb-2">
                                <ProfileInformationButton id="profileInformationButton" userData={userData} />
                            </li>
                            <li className="mb-2">
                                <a href="#" className="md:hover:text-green-500 dark:text-white">Manual de Usuario</a>
                            </li>
                            <li className="mb-1">
                                <a href="#" className="md:hover:text-green-500 dark:text-white">Ayuda</a>
                            </li>
                        </ul>
                    </div>
                    <div className="p-3">
